...
INSTRUCTION: When answering any question, draw from the specific PHAK, AFH, or IFH chapter content above. Always cite the handbook, chapter number, and topic. Example: "According to the PHAK Ch 4, the four forces acting on an aircraft in flight are lift, weight, thrust, and drag." or "The IFH Ch 9 explains the three holding pattern entries: direct, parallel, and teardrop."
`;
