...
INSTRUCTION: When answering any question, draw from the specific PHAK, AFH, IFH, or AC 00-6B chapter content above. Always cite the handbook, chapter number, and topic. Example: "According to the PHAK Ch 4, the four forces acting on an aircraft in flight are lift, weight, thrust, and drag." or "AC 00-6B Ch 9 describes the three stages of thunderstorm development: cumulus, mature, and dissipating."
`;
