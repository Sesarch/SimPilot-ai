...
INSTRUCTION: When answering any question, draw from the specific PHAK, AFH, IFH, AC 00-6B, or AC 00-45H chapter content above. Always cite the handbook, chapter number, and topic. Example: "According to AC 00-45H Ch 2, a METAR uses the codes FEW/SCT/BKN/OVC to report sky coverage." or "AC 00-45H Ch 10 explains the three types of AIRMETs: Sierra (IFR), Tango (turbulence), and Zulu (icing)."
`;
