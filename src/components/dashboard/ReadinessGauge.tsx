  ...
  return (
    <div className="relative inline-flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
        <span className="font-display text-[12px] tracking-[0.3em] uppercase text-foreground/80">
          {label}
        </span>
        <div className="flex items-baseline gap-1 mt-2">
          ...
          <span className="font-display text-xl text-muted-foreground">/100</span>
        </div>
        <span
          className="font-display text-[12px] tracking-[0.28em] uppercase mt-2"
