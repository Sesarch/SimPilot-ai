        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="px-8 py-3 bg-primary text-primary-foreground font-display text-sm tracking-widest uppercase rounded border border-primary/50 hover:shadow-[0_0_30px_hsl(var(--cyan-glow)/0.4)] transition-all duration-300"
            >
              Get Started
            </Link>
            <a
              ...
              className="px-8 py-3 border border-accent/40 text-accent font-display text-sm tracking-widest uppercase rounded hover:border-accent/70 hover:bg-accent/5 transition-all duration-300"
            >
              Contact Us
            </a>
          </div>
