        ...
        >
          {TABS.map(({ value, label, Icon }) => (
            <TabsTrigger
              key={value}
              value={value}
              className="gap-1.5 px-2.5 py-1.5 text-[13px] font-medium tracking-normal text-foreground/70 rounded-md transition-all duration-150 hover:text-foreground hover:bg-muted focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md data-[state=active]:hover:bg-primary data-[state=active]:hover:text-primary-foreground data-[state=active]:focus-visible:ring-ring"
            >
