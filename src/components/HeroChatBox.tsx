...
const HeroChatBox = () => {
  ...
  return (
    <motion.div
      ...
      className="relative w-full max-w-2xl mx-auto rounded-xl border border-border/60 dark:bg-[hsl(220,15%,18%)] bg-card/80 backdrop-blur-xl shadow-[0_0_60px_hsl(var(--cyan-glow)/0.08)] overflow-hidden"
    >
      {/* Gate overlay */}
      <AnimatePresence>
        {limit.showGate && (
      ...
      {/* Messages area */}
      <div ref={scrollRef} className="h-[200px] overflow-y-auto p-4 space-y-3">
        {messages.length === 0 ? (
